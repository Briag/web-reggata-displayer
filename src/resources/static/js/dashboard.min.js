...
app.controller('BoatCtrl', ['$scope', 'Boat', '$cookieStore', BoatCtrl]);

function BoatCtrl($scope, Boat, $cookieStore) {
...
app.controller('TeamEdit', ['$scope', 'Team', 'Teammate', 'Boat', '$cookieStore', '$routeParams', TeamEdit]);

function TeamEdit($scope, Team, Teammate, Boat, $cookieStore, $routeParams) {
    ...
    $scope.addTeammate = function() {
    	if($scope.search.teammate == null) {
    		...
    		for (var i=0; i<$scope.team.teammates.length; i++) {
    			...
    			if(teammate.idTeammate == $scope.search.teammate.idTeammate) {
    				found = true;
    				console.log("true");
    			}
    		}
    		if(found == false) {
        		$scope.team.teammates.push($scope.search.teammate);
    		}
    	}
    };
